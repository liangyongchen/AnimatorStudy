...
/**
 * If there is no bug, then it is created by asen on 2017/11/14,
...
public class DownloadService extends Service {
    ...
    public void onCreate() {
        ...
        registerReceiver(mReceiver, new IntentFilter(DownloadManager.ACTION_DOWNLOAD_COMPLETE)); // 监听下载完成
    }
