package com.hema.baselibrary.util;
...
public class DateTime implements Serializable {
     ...
     */
    public static final String DEFAULT_CSHARP_DATE_TIME_FORMAT_PATTERN = "yyyy-MM-dd'T'HH:mm:ss";
    /**
    ...
    public DateTime(String datetime) {
        ...
        //尝试按yyyy-MM-ddTHH:mm:ss分析
        try {
            result = DateTime.parseDateTime(datetime, DateTime.DEFAULT_CSHARP_DATE_TIME_FORMAT_PATTERN);
    ...
    //region DateTime 构造函数 -- Edit By Howe
    ...
    //endregion DateTime 构造函数 -- Edit By Howe
    ...
    /**
     * 转换为 DEFAULT_CSHARP_DATE_FORMAT_PATTERN (yyyy-MM-ddTHH:mm:ss) 格式字符串
     *
     * @return yyyy-MM-ddTHH:mm:ss格式字符串
     */
    @Override
    public String toString() {
        if (this == null || c == null) {
            ...
            return toDateTimeString(DateTime.DEFAULT_CSHARP_DATE_TIME_FORMAT_PATTERN);
        }
    ...
    /**
     * 转换为 DEFAULT_DATE_FORMAT_PATTERN (yyyy-MM-dd HH:mm) 格式字符串
     *
     * @return yyyy-MM-dd HH:mm格式字符串
     */
    public String toyyMMddHHmmString() {
        return toDateTimeString(DateTime.DEFAULT_DATE_TIME_HHmm_FORMAT_PATTERN);
    }
